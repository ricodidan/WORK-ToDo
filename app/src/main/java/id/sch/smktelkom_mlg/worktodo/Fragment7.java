...
public class Fragment7 extends Fragment implements ReminderAdapter.RecyclerListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.layout_minggu, container, false);
    }
    ...
    public void onViewCreated(View view, Bundle bundle) {
        ...
        getActivity().setTitle("ToDo Minggu");
    }
